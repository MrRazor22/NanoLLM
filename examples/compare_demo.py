...
def main():
    print("\n[INIT] Loading NanoLLM Champion (checkpoints/checkpoint_champion.pt)...", flush=True)
    nano = DecisionEngine.from_checkpoint(str(ROOT / "checkpoints" / "checkpoint_champion.pt"))
